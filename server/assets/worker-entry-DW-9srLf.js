...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CrIZir-0.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router--_oo6zmx.js").then((n2) => n2.a),
...
var ROUTER_BASEPATH = "earthquake-explorer";
var SERVER_FN_BASE = "/earthquake-explorer/_serverFn/";
